...
4. **2.2.0 / 2.3.0 Auto-Update:** `Die Datei "\\" wurde nicht gefunden` — der Updater startete Setup per `start ""`. Auf deutschem Windows ist der leere Titel der Dateiname `\\`. **2.2.0 kann sich nicht selbst updaten.** Einmal **TypeHack-Setup-2.3.1.exe** von Hand starten. Ab 2.3.1 startet der Updater Setup direkt.
